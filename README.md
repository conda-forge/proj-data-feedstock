...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/proj-data-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9229&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/proj-data-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `proj-data` can be installed with:

```
conda install proj-data
```

It is possible to list all of the versions of `proj-data` available on your platform with:
